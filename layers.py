...
"""
Input: node features (h), adjacency (A)

1. Linear transform (W h)
2. Compute pairwise attention e_ij
3. Mask nonexistent edges
4. Softmax normalize α_ij
5. Aggregate neighbors → h'_i = Σ_j α_ij W h_j
6. Merge heads (concat or mean)
